...
async function fillModalInfo(driver) {
  ...
  await driver.findElement(By.name("firstname")).sendKeys("Renata", Key.RETURN);
  await driver.findElement(By.name("lastname")).sendKeys("Dzherhalova", Key.RETURN);

  const email = "genericemail2007@email.com";
